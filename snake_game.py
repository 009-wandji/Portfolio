...
class SnakeGame:
    ...
    def show_menu(self):
        ...
        while True:
            ...
            title = self.font_medium.render("Select Difficulty:", True, COLORS["TEXT"])
    ...
    def draw_score(self, score):
        score_text = self.font_small.render(f"Score: {score}", True, COLORS["TEXT"])
    ...
    def show_game_over(self, score):
        ...
        over_text = self.font_large.render("Game Over!", True, COLORS["TEXT"])
